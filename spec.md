...
## Goal
1. Extract shared runtime lifecycle helpers for nested JSON execution, prompt cleanup, and limit-order failure mapping.
2. Move approvals and limit-order business logic out of `apps/agent-runtime/xclaw_agent/cli.py` behind stable wrappers.
...
2. No liquidity or x402 extraction beyond preserving existing fallback behavior.
...
4. `apps/agent-runtime/xclaw_agent/runtime/state_machine.py`
5. `apps/agent-runtime/tests/test_runtime_state_machine.py`
6. `apps/agent-runtime/tests/test_runtime_contract.py`
...
10. `apps/agent-runtime/tests/test_x402_runtime.py`
